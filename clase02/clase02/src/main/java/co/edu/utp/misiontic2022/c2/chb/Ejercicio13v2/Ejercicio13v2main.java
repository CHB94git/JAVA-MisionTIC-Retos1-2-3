...
public class Ejercicio13v2main {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            switch(opcion){
                case 1:
                    cant = Double.parseDouble(JOptionPane.showInputDialog("Convertir Dólares USD a Pesos COP\n"
                            + "Ingresa la cantidad a convertir"));
                    change.dolaresAPesos(cant);
                    break;
                case 2:
                    cant = Double.parseDouble(JOptionPane.showInputDialog("Convertir Pesos COP a Dólares USD\n"
                            + "Ingresa la cantidad a convertir"));
